 ...
 */
#ifndef __USB_Stylocard_h__
#define __USB_Stylocard_h__
 ...
 public:
    ...
    void delay(long milli) {
      ...
      while (milli > 0) {
        ...
        milli -= now - last;
        last = now;
        //do not poll the usb line since we are already doing that on timer1
        update();
      }
    }
...
USB_Stylocard USB_Stylocard_2 = USB_Stylocard();
